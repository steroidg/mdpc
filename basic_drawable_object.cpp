...
BasicDrawableObject::BasicDrawableObject ( position_ptr p, dimension_ptr d, int bpp )
{
    this->position = p;
    this->dimension = d;
    this->bpp = bpp;
...
position_ptr BasicDrawableObject::get_position()
{
    return position;
}

dimension_ptr BasicDrawableObject::get_dimension()
{
    return dimension;
}
